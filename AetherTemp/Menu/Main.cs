...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
                ...
                transform =
        {
            ...
            GameObject SearchButtonOutline = GameObject.CreatePrimitive(PrimitiveType.Cube);
            if (!UnityInput.Current.GetKey(KeyCode.Q))
            {
                SearchButtonOutline.layer = 2;
            }
            UnityEngine.Object.Destroy(SearchButtonOutline.GetComponent<Rigidbody>());
            SearchButtonOutline.GetComponent<BoxCollider>().isTrigger = true;
            SearchButtonOutline.transform.parent = menu.transform;
            SearchButtonOutline.transform.rotation = Quaternion.identity;
            SearchButtonOutline.transform.localScale = new Vector3(0.08f, 0.82f, 0.08f);
            SearchButtonOutline.transform.localPosition = new Vector3(0.56f, 0f, 0.28f);
            SearchButtonOutline.GetComponent<Renderer>().material.color = new Color(0.06f, 0.06f, 0.06f);
            SearchButtonOutline.AddComponent<Classes.Button>().relatedText = "Search";
            ...
            UnityEngine.Object.Destroy(But1.GetComponent<Rigidbody>());
            ...
            RectTransform rectt2 = But1text.GetComponent<RectTransform>();
            rectt2.localPosition = Vector3.zero;
            rectt2.sizeDelta = new Vector2(0.2f, 0.03f);
            rectt2.localPosition = new Vector3(0.064f, -0.132f, -0.212f);
            ...
            gameObject.transform.localScale = new Vector3(0.06f, 0.25f, 0.06f);
            gameObject.transform.localPosition = new Vector3(0.56f, -0.37f, 0.555f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject1.AddComponent<Classes.Button>().relatedText = "favorite";
            ...
            component1.localPosition = new Vector3(.064f, -0.1f, 0.064f - offset / 2.68f);
